...
import Furniture from '../pages/FurniturePage';
        ...
        <>
            ...
            <div className={classes.ind_page}>
                ...
                <div className={classes.ind_details}>
                    ...
                    <center><Link style={{ textDecoration: 'none' }} to='/furniture' path={<Furniture />}><button className={classes.chBtn}>Go to Furniture</button></Link></center>
                </div>
            </div>
        </>
    );
